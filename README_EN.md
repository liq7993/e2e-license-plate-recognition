...
> 📊 Training-curve overview and confusion matrix are shown in [Artifacts and Verified Metrics](#artifacts-and-verified-metrics).
...
Combined training curves auto-generated by Ultralytics (loss + metrics, 20 epochs):

![training results](runs/detect/train/results.png)

Per-class confusion matrix and PR curve (same Ultralytics artifacts):
